...
$(document).on(
    "click",
    'a[data-ajax-popup="true"],a[data_ajax_popup="true"], button[data-ajax-popup="true"], div[data-ajax-popup="true"], span[data-ajax-popup="true"]',
    function (e) {
...
function commonLoader() {
    ...
    //         document.querySelector("#pc-datepicker-3"),
    //         {
    //             buttonClass: "btn",
    //             todayBtn: true,
    //             clearBtn: true,
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (datepickerElement) {
            ...
            console.warn(
                'Datepicker element with ID "pc-datepicker-3" not found. Datepicker not initialized.'
            );
        }
    });
}
