...
class IyziPayController extends Controller
{
    ...
    public function initiatePayment(Request $request)
    {
        ...
        $currency = $adminPaymentSettings['currency'] ? $adminPaymentSettings['currency'] : 'USD';
            ...
            if ($assignPlan['is_success'] == true && !empty($plan)) {
                ...
                Order::create(
                    [
                        ...
                        'price_currency' => $adminPaymentSettings['currency'] ? $adminPaymentSettings['currency'] : 'USD',
                        'txn_id' => '',
        ...
        if ($invoice) {
            ...
            try {
                ...
                if (\Auth::check()) {
                    ...
                    return redirect()->route('pay.invoice', [$slug, Crypt::encrypt($invoice->id)])->with('success', __('Invoice paid Successfully'));
                }
            } catch (Exception $e) {
