...
class AamarpayController extends Controller
{
    ...
    public function getPaymentStatus($data, Request $request)
    {
        ...
        if ($data['response'] == "success") {
            ...
            $order->price_currency = $payment_setting['currency'] ? $payment_setting['currency'] : 'USD';
            ;
            ...
            if ($assignPlan['is_success']) {
                $planData = [
                    'plan_id' => $plan->id,
                    'plan_frequency' => $data['frequency'],
                    'plan_price' => Utility::getPlanActualPrice($plan->id, $data['frequency'])
                ];
    ...
    public function invoicePayWithAamarpay(Request $request, $slug, $invoice_id)
    {
        ...
        if ($currentWorkspace['currency_code'] == 'BDT') {
