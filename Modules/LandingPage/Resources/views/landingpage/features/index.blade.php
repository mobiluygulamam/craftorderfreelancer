...
@push('script-page')
    <script src="{{ asset('public/landing_page_assets/js/plugins/tinymce.min.js') }}" referrerpolicy="origin"></script>
@endpush
                                        ...
                                        <div class="choose-file mt-5">
                                            <label for="highlight_feature_image">
                                                <div class=" bg-primary dark_logo_update"
                                                    style="cursor: pointer;transform: translateY(+110%);"> <i
                                                        class="ti ti-upload px-1">
                                                    </i>{{ __('Choose file here') }}
                                                </div>
                                                <input type="file" name="highlight_feature_image"
                                                    id="highlight_feature_image" class="form-control choose_file_custom"
