    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('other_featured_description', $other_features['other_featured_description'], ['class' => 'summernote form-control', 'placeholder' => __('Enter Description'), 'id' => 'summernote']) }}
            </div>
        </div>
