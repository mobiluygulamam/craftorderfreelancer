            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    ...
                    <div class="card">
                        ...
                        {{ Form::open(['route' => 'homesection.store', 'method' => 'post', 'id' => 'imageUploadForm', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <div class="choose-file mt-5">
                                            <label for="home_banner">
                                                ...
                                                <input type="file" name="home_banner" id="home_banner"
                                                    class="form-control choose_file_custom" data-filename="home_banner">
                                            </label>
                                        </div>
                                        @error('home_banner')
                                            <div class="row">
