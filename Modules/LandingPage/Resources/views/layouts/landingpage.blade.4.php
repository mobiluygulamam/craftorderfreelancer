                         ...
                         $annually = App\Models\Plan::where('id', 4)->first();
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="saas_price_item">
                                    ...
                                    <div class="price_middle">
                                        <h2>300 ₺<small>/{{__('Per month')}}</small></h2>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="saas_price_item">
                                    ...
                                    <div class="price_middle">
                                        <h2>3000 ₺<small>/{{__('Per Year')}}</small></h2>
                                        <p>{{__('Annual Billing')}}</p>
                                        <span>{{__('2 ay hediyeli')}}</span>
                                        <a href="{{ Auth::check() ?  route('payment', ['annually', \Illuminate\Support\Facades\Crypt::encrypt($annually->id)])  : route('login') }}" class="price_btn">
                                             {{ __('select_this_plan') }}
                                         </a>                                    </div>
                                    <ul class="list-unstyled">
