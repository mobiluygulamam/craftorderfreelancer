                            ...
                            <div data-v-4b3dcb8a="" class="d"
                                ...
                                <div data-v-4b3dcb8a="" class="d-inner"
                                    ...
                                    <div data-v-4b3dcb8a="" class="row">
                                        ...
                                        <div data-v-4b3dcb8a="" class="col-1"><img data-v-4b3dcb8a=""
                                    ...
                                    <div data-v-4b3dcb8a="" class="row">
                                        <div data-v-4b3dcb8a="" class="col-2">
                                            ...
                                            <strong data-v-4b3dcb8a="" class="sub-title">
...
@endif
                                        ...
                                        <div data-v-4b3dcb8a="" class="col-33">
                                            <table data-v-4b3dcb8a="" class="summary-table">
                                                <tbody data-v-4b3dcb8a="">
                                                    ...
                                                    <tr data-v-4b3dcb8a="">
                                                        <td data-v-4b3dcb8a="" class="fwb">{{ __('Issue Date') }}:
                                                        </td>
                                                        <td data-v-4b3dcb8a="" class="text-right">
                                                    ...
                                                    <tr data-v-4b3dcb8a="">
                                                        <td data-v-4b3dcb8a="" class="fwb">{{ __('Due Date') }}:
                                                        </td>
                                                        <td data-v-4b3dcb8a="" class="text-right">
                                    ...
                                    <div data-v-4b3dcb8a="" class="d-table">
                                        <div data-v-4b3dcb8a="" class="d-table">
                                            <div data-v-4b3dcb8a="" class="tu d-table-tr"
                                                style="background: {{ $color }}; padding: 5px; color: {{ $font_color }};">
                                                <div data-v-4b3dcb8a="" class="d-table-th w-2">{{ __('#') }}
                                                </div>
                                                <div data-v-4b3dcb8a="" class="d-table-th w-17">{{ __('Item') }}
                                                </div>
                                                <div data-v-4b3dcb8a="" class="d-table-th w-5 text-right">
                                                    {{ __('Totals') }}</div>
                                            </div>
                                            <div data-v-4b3dcb8a="" class="d-table-body">
                                                @if ($items = $invoice->items)
                                                    @foreach ($items as $key => $item)
                                                        <div data-v-4b3dcb8a="" class="d-table-tr"
                                                            style="border-bottom: 1px solid {{ $color }};">
                                                            <div data-v-e23d9750="" class="d-table-td w-2">
                                                                <span>{{ $key + 1 }}</span>
                                                            </div>
                                                            <div data-v-e23d9750="" class="d-table-td w-17">
                                                                <pre data-v-e23d9750="">{{ $item->task->title }}</pre>
                                                            </div>
                                                            <div data-v-e23d9750="" class="d-table-td w-5 text-right">
                                                                <span
                                                                    data-v-e23d9750="">{{ $currentWorkspace->priceFormat($item->price * $item->qty) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @endif
                                            ...
                                            <div data-v-4b3dcb8a="" class="d-table-footer">
                                                ...
                                                <div data-v-4b3dcb8a="" class="d-table-summary">
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label">
                                                            {{ __('Sub Total') }}:</div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value">
                                                    ...
                                                    @endif
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label"><strong
                                                                data-v-4b3dcb8a="">{{ __('Total') }}:</strong></div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value"><strong
                                                                data-v-4b3dcb8a="">{{ $currentWorkspace->priceFormat($invoice->getTotal()) }}</strong>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
