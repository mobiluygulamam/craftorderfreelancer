                ...
                <div class="invoice-preview-inner">
                    <div class="editor-content">
                        <div class="preview-main client-preview">
                            <div data-v-7d9d14b5="" class="d"
                                style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                                <div data-v-7d9d14b5="" class="d-inner"
                                    style="border-right: 50px solid {{ $color }};">
                                    <div data-v-7d9d14b5="" class="row">
                                        <div data-v-7d9d14b5="" class="col-3">
                                            <h1 data-v-7d9d14b5="" class="fancy-title tu mb5"
                                                style="color: {{ $color == '#ffffff' ? 'black' : $color }};">
                                                {{ __('INVOICE') }}</h1>
                                            <h3 data-v-7d9d14b5="">
                                                {{ App\Models\Utility::invoiceNumberFormat($invoice->invoice_id) }}</h3>
                                            <p data-v-7d9d14b5="">
                                                {{ App\Models\Utility::dateFormat($invoice->issue_date) }}</p>
                                        </div>
                                    ...
                                    <div data-v-7d9d14b5="" class="row">
                                        <div data-v-7d9d14b5="" class="col-33">
                                            <h3 data-v-7d9d14b5="" class="sub-title">
...
@endif
                                            ...
                                            <table data-v-7d9d14b5="" class="summary-table">
                                                <tbody data-v-7d9d14b5="">
                                                    <tr data-v-7d9d14b5="">
                                                        ...
                                                        <td data-v-7d9d14b5="" class="text-right">
                                                            {{ $invoice->project->name }}</td>
                                                    </tr>
                                                    <tr data-v-7d9d14b5="">
                                                        <td data-v-7d9d14b5="" class="fwb">{{ __('Due Date') }}:
                                                        </td>
                                                        <td data-v-7d9d14b5="" class="text-right">
                                    ...
                                    <div data-v-7d9d14b5="" class="d-table">
                                        <div data-v-7d9d14b5="" class="d-table">
                                            <div data-v-7d9d14b5="" class="tu d-table-tr"
                                                style="color: {{ $font_color }}; background: {{ $color }};">
                                                <div data-v-7d9d14b5="" class="d-table-th w-2" style="padding: 3px;">
                                                    {{ __('#') }}</div>
                                                <div data-v-7d9d14b5="" class="d-table-th w-17" style="padding: 3px;">
                                                    {{ __('Item') }}</div>
                                                <div data-v-7d9d14b5="" class="d-table-th w-5 text-right"
                                                    style="padding: 3px;">{{ __('Totals') }}</div>
                                            </div>
                                            <div data-v-7d9d14b5="" class="d-table-body">

                                                @if ($items = $invoice->items)
                                                    @foreach ($items as $key => $item)
                                                        <div data-v-7d9d14b5="" class="d-table-tr"
                                                            style="border-bottom: 1px solid rgb(248, 248, 248);">
                                                            <div data-v-7d9d14b5="" class="d-table-td w-2"
                                                                style="padding: 3px;"><span>{{ $key + 1 }}</span>
                                                            </div>
                                                            <div data-v-7d9d14b5="" class="d-table-td w-17"
                                                                style="padding: 3px;">
                                                                <pre data-v-7d9d14b5="">{{ $item->task->title }}</pre>
                                                            </div>
                                                            <div data-v-7d9d14b5="" class="d-table-td w-5 text-right"
                                                                style="padding: 3px;"><span
                                                                    data-v-7d9d14b5="">{{ $currentWorkspace->priceFormat($item->price * $item->qty) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @endif
                                            ...
                                            <div data-v-7d9d14b5="" class="d-table-footer">
                                                ...
                                                <div data-v-7d9d14b5="" class="d-table-summary">
                                                    <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                        <div data-v-7d9d14b5="" class="tu d-table-label">
                                                            {{ __('Sub Total') }}:</div>
                                                        <div data-v-7d9d14b5="" class="d-table-value">
                                                    ...
                                                    <div data-v-7d9d14b5="" class="d-table-summary-item"
                                                        ...
                                                        <div data-v-7d9d14b5="" class="tu d-table-label">
                                                            {{ __('Total') }}:</div>
                                                        <div data-v-7d9d14b5="" class="d-table-value">
                                                            {{ $currentWorkspace->priceFormat($invoice->getTotal()) }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
