...
@endif
                                        ...
                                        <div data-v-363339a0="" class="col-1">
                                            <img data-v-363339a0=""
                                                ...
                                                style="max-width: 150px" class="d-logo">
                                        </div>
                                    ...
                                    <div data-v-363339a0="" class="row">
                                        <div data-v-363339a0="" class="col-66">
                                            <strong data-v-363339a0="" class="tu mb5"
                                                style="color: {{ $color == '#ffffff' ? 'black' : $color }};">{{ __('Bill To') }}:</strong>
                                            @if ($invoice->client)
                                    ...
                                    <div data-v-363339a0="" class="d-table">
                                        <div data-v-363339a0="" class="d-table">
                                            <div data-v-363339a0="" class="tu d-table-tr"
                                                style="color: {{ $color == '#ffffff' ? 'black' : $color }}; border-bottom: 2px solid {{ $color }}; border-top: 2px solid {{ $color }};">
                                                <div data-v-363339a0="" class="d-table-th w-2">{{ __('#') }}
                                                </div>
                                                <div data-v-363339a0="" class="d-table-th w-17">{{ __('Item') }}
                                                </div>
                                                <div data-v-363339a0="" class="d-table-th w-5 text-right">
                                                    {{ __('Totals') }}</div>
                                            </div>
                                                ...
                                                @if ($items = $invoice->items)
                                                    @foreach ($items as $key => $item)
                                                        <div data-v-363339a0="" class="d-table-tr">
                                                            <div data-v-363339a0="" class="d-table-td w-2">
                                                                <span>{{ $key + 1 }}</span>
                                                            </div>
                                                            <div data-v-363339a0="" class="d-table-td w-17">
                                                                <pre data-v-363339a0="">{{ $item->task->title }}</pre>
                                                            </div>
                                                            <div data-v-363339a0="" class="d-table-td w-5 text-right">
                                                                <span
                                            ...
                                            <div data-v-363339a0="" class="d-table-footer">
                                                ...
                                                <div data-v-363339a0="" class="d-table-summary">
                                                    <div data-v-363339a0="" class="d-table-summary-item">
                                                        <div data-v-363339a0="" class="tu d-table-label">
                                                            {{ __('Sub Total') }}:</div>
                                                        <div data-v-363339a0="" class="d-table-value">
                                                    ...
                                                    @endif
                                                    <div data-v-363339a0="" class="d-table-summary-item">
                                                        <div data-v-363339a0="" class="fwb f-b tu d-table-label"
                                                            style="color: {{ $color == '#ffffff' ? 'black' : $color }};">
                                                            {{ __('Total') }}:</div>
                                                        <div data-v-363339a0="" class="fwb f-b d-table-value"
                                                            style="color: {{ $color == '#ffffff' ? 'black' : $color }};">
