                                ...
                                <div data-v-b8f60a0c="" class="d-inner">
                                    <div data-v-b8f60a0c="" class="row">
                                        <div data-v-b8f60a0c="" class="col-33">
                                            <h1 data-v-b8f60a0c="" class="fancy-title tu mb5"
                                                style="color: {{ $color == '#ffffff' ? 'black' : $color }}; border-top: 15px solid {{ $color }};">
                                                {{ __('INVOICE') }}</h1>
                                        </div>
                                        <div data-v-b8f60a0c="" class="col-33"></div>
                                        <div data-v-b8f60a0c="" class="col-33"><img data-v-b8f60a0c=""
                                                style="max-width: 200px;" class="d-logo"
                                    ...
                                    <div data-v-b8f60a0c="" class="row">
                                        <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5"
                                                style="color: {{ $color == '#ffffff' ? 'black' : $color }};">{{ __('From') }}:</strong>
                                            <p data-v-b8f60a0c="">
...
@endif
                                    ...
                                    <div data-v-b8f60a0c="" class="row">
                                        <div data-v-b8f60a0c="" class="col-2">
                                            <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c=""
                                                    class="tu mb5"
                                                    style="color: {{ $color == '#ffffff' ? 'black' : $color }};">{{ __('To') }}:</strong>
                                                @if ($invoice->client)
                                                    <p data-v-b8f60a0c="">{{ $invoice->client->name }}</p>
                                    ...
                                    <div data-v-b8f60a0c="" class="d-table">
                                        <div data-v-b8f60a0c="" class="d-table">
                                            <div data-v-b8f60a0c="" class="tu d-table-tr"
                                                style="color: {{ $color == '#ffffff' ? 'black' : $color }}; border-bottom: 1px solid {{ $color }}; border-top: 1px solid {{ $color }};">
                                                <div data-v-b8f60a0c="" class="d-table-th w-2">{{ __('#') }}
                                                </div>
                                                <div data-v-b8f60a0c="" class="d-table-th w-17">{{ __('Item') }}
                                                </div>
                                                <div data-v-b8f60a0c="" class="d-table-th w-5 text-right">
                                                    {{ __('Totals') }}</div>
                                            </div>
                                                ...
                                                @if ($items = $invoice->items)
                                                    @foreach ($items as $key => $item)
                                                        <div data-v-b8f60a0c="" class="d-table-tr">
                                                            <div data-v-b8f60a0c="" class="d-table-td w-2">
                                                                <span>{{ $key + 1 }}</span>
                                                            </div>
                                                            <div data-v-b8f60a0c="" class="d-table-td w-17">
                                                                <pre data-v-b8f60a0c="">{{ $item->task->title }}</pre>
                                                            </div>
                                                            <div data-v-b8f60a0c="" class="d-table-td w-5 text-right">
                                                                <span
                                                                    data-v-b8f60a0c="">{{ $currentWorkspace->priceFormat($item->price * $item->qty) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @endif
                                            ...
                                            <div data-v-b8f60a0c="" class="d-table-footer">
                                                ...
                                                <div data-v-b8f60a0c="" class="d-table-summary">
                                                    <div data-v-b8f60a0c="" class="d-table-summary-item">
                                                        <div data-v-b8f60a0c="" class="tu d-table-label">
                                                            {{ __('Sub Total') }}:</div>
                                                        <div data-v-b8f60a0c="" class="d-table-value">
