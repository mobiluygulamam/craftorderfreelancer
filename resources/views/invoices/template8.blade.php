                                    ...
                                    <div data-v-136bf9b5="" class="row">
                                        <div data-v-136bf9b5="" class="col-66">
                                            <img data-v-136bf9b5=""
                                                ...
                                                class="d-logo" style="max-width: 200px;">
                                            <h3 data-v-136bf9b5="">
...
@endif
                                        ...
                                        <div data-v-136bf9b5="" class="col-33">
                                            <h1 data-v-136bf9b5="" class="fancy-title mb5"
                                    ...
                                    <div data-v-136bf9b5="" class="row">
                                        <div data-v-136bf9b5="" class="col-66"><strong data-v-136bf9b5=""
                                                class="mb5">{{ __('Bill To') }}:</strong>
                                            ...
                                            <table data-v-136bf9b5="" class="summary-table">
                                                <tbody data-v-136bf9b5="">
                                                    <tr data-v-136bf9b5="">
                                                        ...
                                                        <td data-v-136bf9b5="" class="text-right">
                                                    ...
                                                    <tr data-v-136bf9b5="">
                                                        <td data-v-136bf9b5="" class="fwb">{{ __('Issue Date') }}:
                                                        </td>
                                                        <td data-v-136bf9b5="" class="text-right">
                                                    ...
                                                    <tr data-v-136bf9b5="">
                                                        <td data-v-136bf9b5="" class="fwb">{{ __('Due Date') }}:
                                                        </td>
                                                        <td data-v-136bf9b5="" class="text-right">
                                    ...
                                    <div data-v-136bf9b5="" class="d-table">
                                        <div data-v-136bf9b5="" class="d-table">
                                            <div data-v-136bf9b5="" class="d-table-tr">
                                                <div data-v-136bf9b5="" class="d-table-th w-2">{{ __('#') }}
                                                </div>
                                                <div data-v-136bf9b5="" class="d-table-th w-17">{{ __('Item') }}
                                                </div>
                                                <div data-v-136bf9b5="" class="d-table-th w-5 text-right">
                                                    {{ __('Totals') }}</div>
                                            </div>
                                            <div data-v-136bf9b5="" class="d-table-body">
                                                @if ($items = $invoice->items)
                                                    @foreach ($items as $key => $item)
                                                        <div data-v-136bf9b5="" class="d-table-tr">
                                                            <div data-v-136bf9b5="" class="d-table-td w-2">
                                                                <span>{{ $key + 1 }}</span>
                                                            </div>
                                                            <div data-v-136bf9b5="" class="d-table-td w-17">
                                                                <pre data-v-136bf9b5="">{{ $item->task->title }}</pre>
                                                            </div>
                                                            <div data-v-136bf9b5="" class="d-table-td w-5 text-right">
                                                                <span
                                                                    data-v-136bf9b5="">{{ $currentWorkspace->priceFormat($item->price * $item->qty) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @endif
                                            ...
                                            <div data-v-136bf9b5="" class="d-table-footer">
                                                ...
                                                <div data-v-136bf9b5="" class="d-table-summary">
                                                    <div data-v-136bf9b5="" class="d-table-summary-item">
                                                        <div data-v-136bf9b5="" class="d-table-label">
                                                            {{ __('Sub Total') }}:</div>
                                                        <div data-v-136bf9b5="" class="d-table-value">
