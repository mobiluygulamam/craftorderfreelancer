                        ...
                        <div class="preview-main client-preview">
                            <div data-v-f2a183a6="" class="d" id="boxes">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-inner">
                                        <div data-v-f2a183a6="" class="d-header-50">
                                            <div data-v-f2a183a6="" class="d-header-brand">
                                                <img src="@if ($currentWorkspace->logo) {{ asset($logo . $currentWorkspace->logo) }} @else{{ asset($logo . 'logo-light.png') }} @endif"
                                                ...
                                                @if ($currentWorkspace->city)
                                                    ...
                                                    @endif @if ($currentWorkspace->state)
                                                        ...
                                                        @if ($currentWorkspace->country)
                                                            <br>{{ $currentWorkspace->country }}
                                                        @endif
                                                        @if ($currentWorkspace->telephone)
                                                            <br>{{ $currentWorkspace->telephone }}
                                                        @endif
                                            </p>
                                        ...
                                        <div data-v-f2a183a6="" class="d-header-50 d-right">
                                            ...
                                            <table data-v-f2a183a6="" class="summary-table">
                                                <tbody data-v-f2a183a6="">
                                                    <tr>
                                                        <td>{{ __('Number') }}:</td>
                                                        <td>{{ App\Models\Utility::invoiceNumberFormat($invoice->invoice_id) }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ __('Project') }}:</td>
                                                    ...
                                                    <tr>
                                                        <td>{{ __('Issue Date') }}:</td>
                                                        <td>{{ App\Models\Utility::dateFormat($invoice->issue_date) }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ __('Due Date') }}:</td>
                                                        <td>{{ App\Models\Utility::dateFormat($invoice->due_date) }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <div data-v-f2a183a6="" class="d-body">
                                    <div data-v-f2a183a6="" class="d-bill-to"><strong
                                            data-v-f2a183a6="">{{ __('Bill To') }}:</strong>
                                        @if ($invoice->client)
                                            <p>
                                                {{ $invoice->client->name }}
                                                ...
                                                @if ($invoice->client->city)
                                                    ...
                                                    @endif @if ($invoice->client->state)
                                                        ...
                                                        @endif @if ($invoice->client->zipcode)
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-summary-item"
                                                            ...
                                                            <div data-v-f2a183a6="" class="d-table-label">
                                                                {{ __('Due Amount') }}:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">
                                                                {{ $currentWorkspace->priceFormat($invoice->getDueAmount()) }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
