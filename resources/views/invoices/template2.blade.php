                                ...
                                <div data-v-37eeda86="" class="d-inner">
                                    ...
                                    <div data-v-37eeda86="" class="row">
                                        <div data-v-37eeda86="" class="col-66">
                                            <strong class="tu mb5"
                                                style="color: {{ $color == '#ffffff' ? 'black' : $color }};">{{ __('Billing Address') }}:</strong>
                                            @if ($invoice->client)
                                            ...
                                            <table data-v-37eeda86="" class="summary-table">
                                                <tbody data-v-37eeda86="">
                                                    <tr data-v-37eeda86="">
                                                        ...
                                                        <td data-v-37eeda86="" class="text-right">
                                                    ...
                                                    <tr data-v-37eeda86="">
                                                        <td data-v-37eeda86="" class="tu">{{ __('Issue Date') }}:
                                                        </td>
                                                        <td data-v-37eeda86="" class="text-right">
                                                    ...
                                                    <tr data-v-37eeda86="">
                                                        <td data-v-37eeda86="" class="tu">{{ __('Due Date') }}:
                                                        </td>
                                                        <td data-v-37eeda86="" class="text-right">
