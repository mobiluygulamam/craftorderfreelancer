...
@section('action-button')
    @auth('web')
        @if ($currentWorkspace->creater->id == Auth::user()->id)
            <a href="{{ route('invoice.export') }}" class="btn btn-sm btn-primary mx-1" data-toggle="tooltip"
                title="{{ __('Export') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($invoice->status == 'partialy paid')
                                                    <span
                                                        class="badge bg-warning p-2 px-3 rounded">{{ __('Partialy Paid') }}</span>
                                            ...
                                            @auth('web')
                                                <td class="text-right">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-size="lg" data-toggle="tooltip" title="{{ __('Edit Invoices') }}"
                                                        data-ajax-popup="true" data-title="{{ __('Edit Invoice') }}">
