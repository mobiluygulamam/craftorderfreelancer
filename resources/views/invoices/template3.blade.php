                        ...
                        <div class="preview-main client-preview">
                            <div data-v-e95a8a8c="" class="d"
                                ...
                                <div data-v-e95a8a8c="" class="d-inner">
                                    ...
                                    <div data-v-e95a8a8c="" class="row">
                                        <div data-v-e95a8a8c="" class="col-66"><strong data-v-e95a8a8c="" class="tu mb5"
...
@endif
                                        ...
                                        <div data-v-e95a8a8c="" class="col-33">
                                            <table data-v-e95a8a8c="" class="summary-table">
                                                <tbody data-v-e95a8a8c="">
                                                    <tr data-v-e95a8a8c="">
                                                        <td data-v-e95a8a8c="" class="tu fwb"
                                                            style="color: {{ $color == '#ffffff' ? 'black' : $color }};">
                                                            {{ __('Number') }}:</td>
                                                        <td data-v-e95a8a8c="" class="text-right">
                                    ...
                                    <div data-v-e95a8a8c="" class="row">
                                        <div data-v-e95a8a8c="" class="col-3">
                                            <div data-v-e95a8a8c="" class="col-80"><strong data-v-e95a8a8c=""
                                                    class="tu mb5"
                                    ...
                                    <div data-v-e95a8a8c="" class="d-table">
                                        <div data-v-e95a8a8c="" class="d-table">
                                            <div data-v-e95a8a8c="" class="tu d-table-tr"
                                                ...
                                                <div data-v-e95a8a8c="" class="d-table-th w-2">{{ __('#') }}
                                                </div>
                                                <div data-v-e95a8a8c="" class="d-table-th w-17">{{ __('Item') }}
                                                </div>
                                                <div data-v-e95a8a8c="" class="d-table-th w-5 text-right">
                                                    {{ __('Totals') }}</div>
                                            </div>
                                            <div data-v-e95a8a8c="" class="d-table-body">
                                                @if ($items = $invoice->items)
                                                    @foreach ($items as $key => $item)
                                                        <div data-v-e95a8a8c="" class="d-table-tr"
                                                            style="border-bottom: 1px solid {{ $color }};">
                                                            <div data-v-e95a8a8c="" class="d-table-td w-2">
                                                                <span>{{ $key + 1 }}</span>
                                                            </div>
                                                            <div data-v-e95a8a8c="" class="d-table-td w-17">
                                                                <pre data-v-e95a8a8c="">{{ $item->task->title }}<br data-v-e95a8a8c=""></pre>
                                                            </div>
                                                            <div data-v-e95a8a8c="" class="d-table-td w-5 text-right">
                                                                <span
                                                                    data-v-e95a8a8c="">{{ $currentWorkspace->priceFormat($item->price * $item->qty) }}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @endif
                                            ...
                                            <div data-v-e95a8a8c="" class="d-table-footer">
                                                ...
                                                <div data-v-e95a8a8c="" class="d-table-summary">
                                                    <div data-v-e95a8a8c="" class="d-table-summary-item">
                                                        <div data-v-e95a8a8c="" class="tu d-table-label">
                                                            {{ __('Sub Total') }}:</div>
                                                        <div data-v-e95a8a8c="" class="d-table-value">
