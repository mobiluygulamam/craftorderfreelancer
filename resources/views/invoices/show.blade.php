                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            @if ($plan->storage_limit <= $workspace_owner->storage_limit && $plan->storage_limit != -1)
                                <h6 class="px-2 text-danger">
                                    {{ __('Note: Your plan storage limit is over , so you can not see clients uploaded payment receipt.') }}
                                </h6>
                            @endif
                            <div class="table-responsive mt-3">
                                <table class="table  invoice-detail-table">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-icon-user">
                                        ...
                                        <input class="form-control currency_input" type="number" id="amount"
                                            ...
                                            placeholder="{{ __('Enter Monthly Price') }}" required>
                                    </div>
                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        ...
                                                        <p class="mb-0 pt-1 text-sm">
                                                            {{ __('Safe money transfer using your bank account. We support Mastercard,
                                    ...
                                    @if (isset($paymentSetting['is_flutterwave_enabled']) && $paymentSetting['is_flutterwave_enabled'] == 'on')
                                        <div class="tab-pane fade" id="flutterwave-payment" role="tabpanel"
                                            ...
                                            <form method="post"
                                                ...
                                                <div class="col-md-12 modal-footer">
                                                    <button class="btn btn-primary" type="button"
                                                        id="pay_with_flaterwave">{{ __('Make
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                Payment') }}</button>
                                                </div>
                                            </form>
                                        </div>
...
@auth('client')
    @if (
        ($invoice->getDueAmounts($invoice->id) > 0 && $currentWorkspace->is_stripe_enabled == 1) ||
            $currentWorkspace->is_paypal_enabled == 1 ||
