                ...
                <div class="invoice-preview-inner">
                    <div class="editor-content">
                        <div class="preview-main client-preview">
                            <div data-v-1ad6e3b9="" class="d"
                                style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                                <div data-v-1ad6e3b9="" class="d-inner d-no-pad"
                                    style="border-top: 15px solid {{ $color }}; border-bottom: 15px solid {{ $color }};">
                                    <div data-v-1ad6e3b9="" class="row grey-box">
                                        <div data-v-1ad6e3b9="" class="col-33"><img data-v-1ad6e3b9=""
                                                src="@if ($currentWorkspace->logo) {{ asset($logo . $currentWorkspace->logo) }} @else{{ asset($logo . 'logo-light.png') }} @endif"
                                                class="d-logo" style="max-width: 200px;"> <br data-v-1ad6e3b9=""><br
                                                data-v-1ad6e3b9="">
                                            <p data-v-1ad6e3b9="">
...
@endif
                                            ...
                                            <p data-v-1ad6e3b9="">
                                                @if ($currentWorkspace->city)
                                                    ...
                                                    @endif @if ($currentWorkspace->state)
                                                        {{ $currentWorkspace->state }}
                                                        @endif @if ($currentWorkspace->zipcode)
                                                            - {{ $currentWorkspace->zipcode }}
                                                        @endif
                                            </p>
                                            <p data-v-1ad6e3b9="">
                                        ...
                                        <div data-v-1ad6e3b9="" class="col-33">
                                            <h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{ __('INVOICE') }}</h1> <br
                                                data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                            <table data-v-1ad6e3b9="" class="summary-table">
                                                <tbody data-v-1ad6e3b9="">
                                                    <tr data-v-1ad6e3b9="">
                                                        <td data-v-1ad6e3b9="" class="fwb">{{ __('Number') }}:</td>
                                                        <td data-v-1ad6e3b9="" class="text-right">
                                                    ...
                                                    <tr data-v-1ad6e3b9="">
                                                        <td data-v-1ad6e3b9="" class="fwb">{{ __('Issue Date') }}:
                                                        </td>
                                                        <td data-v-1ad6e3b9="" class="text-right">
                                                    ...
                                                    <tr data-v-1ad6e3b9="">
                                                        <td data-v-1ad6e3b9="" class="fwb">{{ __('Due Date') }}:
                                                        </td>
                                                        <td data-v-1ad6e3b9="" class="text-right">
                                    ...
                                    <div data-v-1ad6e3b9="" class="d-inner-2">
                                        <div data-v-1ad6e3b9="" class="row">
                                            <div data-v-1ad6e3b9="" class="col-2">
                                                <div data-v-1ad6e3b9="" class="col-66">
                                                    ...
                                                    <strong data-v-1ad6e3b9=""
                                                        class="sub-title">{{ $invoice->client->name }}</strong>
                                                    @if ($invoice->client->address)
                                                        {{ $invoice->client->address }}
                                                    @endif
                                                    @if ($invoice->client->city)
                                                        <br> {{ $invoice->client->city }},
                                                        @endif @if ($invoice->client->state)
                                                        ...
                                                        @if ($invoice->client->country)
                                                            <br>{{ $invoice->client->country }}
                                                        @endif
                                                        <br>{{ $invoice->client->email }}
                                                        @if ($invoice->client->telephone)
                                                            <br>{{ $invoice->client->telephone }}
                                                        @endif
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div data-v-1ad6e3b9="" class="d-table">
                                            <div data-v-1ad6e3b9="" class="d-table">
                                                <div data-v-1ad6e3b9="" class="tu d-table-tr"
                                                    style="background: {{ $color }};color:{{ $font_color }};">
                                                    <div data-v-1ad6e3b9="" class="d-table-th w-2"
                                                        style="padding: 5px;">{{ __('#') }}</div>
                                                    <div data-v-1ad6e3b9="" class="d-table-th w-17"
                                                        style="padding: 5px;">{{ __('Item') }}</div>
                                                    <div data-v-1ad6e3b9="" class="d-table-th w-5 text-right"
                                                        style="padding: 5px;">{{ __('Totals') }}</div>
                                                </div>
                                                <div data-v-1ad6e3b9="" class="d-table-body">
                                                    @if ($items = $invoice->items)
                                                        @foreach ($items as $key => $item)
                                                            <div data-v-1ad6e3b9="" class="d-table-tr">
                                                                <div data-v-1ad6e3b9="" class="d-table-td w-2"
                                                                    style="border: 1px solid {{ $color }}; padding: 5px;">
                                                                    <span>{{ $key + 1 }}</span>
                                                                </div>
                                                                <div data-v-1ad6e3b9="" class="d-table-td w-17"
                                                                    style="border: 1px solid {{ $color }}; padding: 5px;">
                                                                    <pre data-v-1ad6e3b9="">{{ $item->task->title }}</pre>
                                                                </div>
                                                                <div data-v-1ad6e3b9=""
                                                                    class="d-table-td w-5 text-right"
                                                                    style="border: 1px solid {{ $color }}; padding: 5px;">
                                                                    <span
                                                                        data-v-1ad6e3b9="">{{ $currentWorkspace->priceFormat($item->price * $item->qty) }}</span>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                    @endif
                                                ...
                                                <div data-v-1ad6e3b9="" class="d-table-footer">
                                                    ...
                                                    <div data-v-1ad6e3b9="" class="d-table-summary">
                                                        <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                            <div data-v-1ad6e3b9="" class="tu d-table-label">
                                                                {{ __('Sub Total') }}:</div>
                                                            <div data-v-1ad6e3b9="" class="d-table-value">
                                                                {{ $currentWorkspace->priceFormat($invoice->getSubTotal()) }}
                                                            </div>
                                                        </div>
                                                        @if ($invoice->discount)
                                                            <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                                <div data-v-1ad6e3b9="" class="tu d-table-label">
                                                                    {{ __('Discount') }}:</div>
                                                                <div data-v-1ad6e3b9="" class="d-table-value">-
                                                                    {{ $currentWorkspace->priceFormat($invoice->discount) }}
                                                                </div>
                                                            </div>
                                                        @endif
                                                        @if ($invoice->tax)
                                                            <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                                <div data-v-1ad6e3b9="" class="tu d-table-label">
                                                                    {{ $invoice->tax->name }}
                                                                    ({{ $invoice->tax->rate }}%):</div>
                                                                <div data-v-1ad6e3b9="" class="d-table-value">
                                                                    {{ $currentWorkspace->priceFormat($invoice->getTaxTotal()) }}
                                                                </div>
                                                            </div>
                                                        @endif
                                                        <div data-v-1ad6e3b9="" class="d-table-summary-item">
                                                            <div data-v-1ad6e3b9="" class="tu d-table-label"><strong
                                                                    data-v-1ad6e3b9="">{{ __('Total') }}:</strong>
                                                            </div>
                                                            <div data-v-1ad6e3b9="" class="d-table-value"><strong
                                                                    data-v-1ad6e3b9="">{{ $currentWorkspace->priceFormat($invoice->getTotal()) }}</strong>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
