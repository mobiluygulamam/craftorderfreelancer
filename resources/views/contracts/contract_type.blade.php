                                            ...
                                            @auth('web')
                                                <td class="text-right">
                                                    <a href="#"
                                                        ...
                                                        data-size="md" data-toggle="tooltip"
                                                        title="{{ __('Edit Contract Type') }}" data-ajax-popup="true"
                                                        data-title="{{ __('Edit Contract Type') }}">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-toggle="tooltip" title="{{ __('Delete Contract Type') }}">
