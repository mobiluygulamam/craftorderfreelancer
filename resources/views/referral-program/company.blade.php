...
@php
    $currency = isset($currentWorkspace['currency']) ? $currentWorkspace['currency'] : '$';
@endphp
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-md-6 ">
                                    <div class = "border border-2 p-3">
                                        <h4>{{ __('Refer ' . \Auth::user()->name . ' and earn ') . $currency . (isset($setting) ? $setting->minimum_threshold_amount : '') . __(' per paid signup!') }}
                                        </h4>
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 mt-5">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <a href="#" class="btn btn-sm btn-light-primary w-100 cp_link"
                                            ...
                                            data-toggle="tooltip"
                                            data-original-title="{{ __('Click to copy invoice link') }}" title=""
                                    ...
                                    @if (isset($setting['is_enable'])&&$setting['is_enable'] != 1)
                                        <div class="text-center my-2">
                                            <small class="text-danger">
                                                {{ __('Note : super admin has disabled the referral program.') }}
                                            </small>
                                        </div>
                                    @endif
                                </div>
