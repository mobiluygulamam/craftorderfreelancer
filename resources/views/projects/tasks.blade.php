    ...
    <script>
        $(function() {
            ...
            function cb(start, end) {
                $("#duration1").val(start.format('DD MMM, YYYY') + ' - ' + end.format('DD MMM, YYYY'));
                $('input[name="start_date1"]').val(start.format('DD MMM, YYYY'));
                $('input[name="due_date1"]').val(end.format('DD MMM, YYYY'));
            }
