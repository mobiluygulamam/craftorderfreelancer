...
@section('action-button')
    @if (
        (isset($permissions) && in_array('create bug report', $permissions)) ||
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(document).on("click", ".delete-comment", function() {
                // show_toastr('{{ __('Error') }}', '{{ __('This operation is not perform due to demo mode !!') }}', 'error');
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            show_toastr('{{ __('Error') }}',
                                '{{ __('This operation is not perform due to demo mode !!') }}',
                                'error');
            ...
            $(document).on('submit', '#form-file', function(e) {
                ...
                $.ajax({
                    ...
                    processData: false,
                    success: function(data) {
                        show_toastr('{{ __('Success1') }}',
                            '{{ __('This operation is not perform due to demo mode!') }}', '1success');
                        // console.log(data);
                        var delLink = '';
