@if ($project && $currentWorkspace)
    <form method="post" class="needs-validation" novalidate
        action="@auth('web'){{ route('projects.bug.report.store', [$currentWorkspace->slug, $project->id]) }}@elseauth{{ route('client.projects.bug.report.store', [$currentWorkspace->slug, $project->id]) }}@endauth">
        @csrf
