            ...
            <select name="language" id="language" class=" btn-primary btn "
                ...
                @foreach (App\Models\Utility::languages() as $langCode => $language)
                    <option class="" @if ($lang == $langCode) selected @endif
                        ...
                        {{ ucfirst(\App\Models\Utility::getlang_fullname($langCode)) }}
                    </option>
                @endforeach
            </select>
        </a>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div style="min-height:70vh"
                                                class="row kanban-wrapper horizontal-scroll-cards" data-toggle="dragula"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="card-header-right">
                                                                                <div class="btn-group card-option">
                                                                                    @if ($currentWorkspace->permission == 'client' || isset($permissions))
                                                                                        {{-- <button type="button"
