@if ($currentWorkspace)
    <form class="needs-validation" novalidate method="post"
        action="{{ route('timesheet.store', [$currentWorkspace->slug]) }}">
        @csrf
        <div class="modal-body">
            ...
            <div class="form-group">
                <label for="task_id" class="col-form-label">{{ __('Task') }}</label><x-required></x-required>
            ...
            <div class="form-group">
                <label for="date" class="col-form-label">{{ __('Date') }}</label><x-required></x-required>
