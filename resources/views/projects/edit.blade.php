<form method="post" action="{{ route('projects.update', [$currentWorkspace->slug, $project->id]) }}"
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="form-group col-md-12">
                <label for="projectname" class="form-label">{{ __('Name') }}</label><x-required></x-required>
            ...
            <div class="form-group col-md-6">
                ...
                <div class="form-icon-user ">
                    ...
                    <input class="form-control currency_input" type="number" min="0" id="budget"
                        name="budget" value="{{ $project->budget }}" placeholder="{{ __('Project Budget') }}">
                </div>
            </div>
            <div class="form-group col-md-6">
                ...
                <div class="input-group date ">
                    <input class="form-control datepicker2" type="text" id="start_date" name="start_date"
                        value="{{ $project->start_date }}" autocomplete="off" required="required">
            ...
            <div class="form-group col-md-6">
                ...
                <div class="input-group date ">
                    <input class="form-control datepicker3" type="text" id="end_date" name="end_date"
                        value="{{ $project->end_date }}" autocomplete="off" required="required">
                    <span class="input-group-text">
                        <i class="feather icon-calendar"></i>
                    </span>
                </div>
