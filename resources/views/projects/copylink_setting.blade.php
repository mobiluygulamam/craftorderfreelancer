    ...
    <div class="table-responsive">
        ...
        <div class="row col-12 m-0">
            <div class="text-start col-6 py-3">
                <a id="cp_link" href="#" class="btn btn-xs btn-primary btn-icon-only cp_link "
                    data-link="{{ route('projects.link', [$currentWorkspace->slug, \Illuminate\Support\Facades\Crypt::encrypt($project->id)]) }}"
                    data-toggle="popover" title="Copy Project" {{-- data-original-title="{{ __('Click to copy project link') }}" --}}><span
