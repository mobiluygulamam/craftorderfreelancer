...
@section('action-button')
    @auth('web')
        <a href="#" class="btn btn-sm btn-primary" data-toggle="tooltip" title="{{ __('Create') }}" data-ajax-popup="true"
            data-size="lg" data-title="{{ __('Create New Note') }}"
            data-url="{{ route('note.create', $currentWorkspace->slug) }}">
                                                ...
                                                <div class="btn-group card-option">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a href="#" class="dropdown-item" data-ajax-popup="true"
                                                            ...
                                                            data-url="{{ route('notes.edit', [$currentWorkspace->slug, $note->id]) }}">
                                                        ...
                                                        <form id="delete-form-{{ $note->id }}"
                                                            action="{{ route('notes.destroy', [$currentWorkspace->slug, $note->id]) }}"
