                ...
                <li class="dropdown dash-h-item drp-language">
                    ...
                    <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                        @foreach ($languages as $languageCode => $languageFullName)
                            <a class="dropdown-item {{ $languageCode == $lang ? 'active' : '' }}" tabindex="0" pwdpwdpwd
                                href="{{ route('client.login', $languageCode) }}">
        ...
        @section('content')
            <div class="card-body">
                ...
                <div class="d-grid col-12 mt-3">
                    <a href="{{ route('login', $lang) }}" type="button" class="btn btn-primary btn-block mt-2"
                        style="color:#fff">{{ __('User Login') }}</a>
                </div>
