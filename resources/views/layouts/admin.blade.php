...
<head>
    ...
    @else
        <link rel="shortcut icon"
            href="@if ($currentWorkspace->favicon) {{ asset($logo . $currentWorkspace->favicon . '?timestamp=' . strtotime(isset($currentWorkspace) ? $currentWorkspace->updated_at : '')) }}@else{{ asset($logo . 'favicon.png' . '?' . time()) }} @endif">
    @endif
