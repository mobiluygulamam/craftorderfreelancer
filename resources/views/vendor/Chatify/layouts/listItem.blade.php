        ...
        <tr data-action="0">
            ...
            <td>
                @if ($color == 'theme-1')
                    <div class="avatar av-m" style="background-color: #d9efff; text-align: center;">
                        <span class="far fa-bookmark"
                            style="font-size: 22px; color: #51459d; margin-top: 12px !important;"></span>
                    </div>
                @endif
                @if ($color == 'theme-2')
                    <div class="avatar av-m" style="background-color: #d9efff; text-align: center;">
                ...
                @if ($color == 'theme-4')
                    <div class="avatar av-m" style="background-color: #d9efff; text-align: center;">
                        <span class="far fa-bookmark"
                            style="font-size: 22px; color: #584ed2; margin-top: 12px !important;"></span>
                    </div>
                @endif
        ...
        <tr data-action="0">
            ...
            <td style="position: relative">
                ...
                @if (!empty($user->avatar))
                    <div class="avatar av-m" style="background-image: url('{{ asset($avatar . $user->avatar) }}');">
                    </div>
                @else
                    <div class="avatar av-m" style="background-image: url('{{ asset($avatar . 'avatar.png') }}');">
                    </div>
                @endif
            </td>
            {{-- center side --}}
