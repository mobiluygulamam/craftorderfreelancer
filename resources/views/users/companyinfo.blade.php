                        ...
                        <div class="col-4 text-center">
                            ...
                            <p class=" text-sm mb-0">
                                <i class="ti ti-users text-primary card-icon-text-space fs-5 mx-1"></i><span
                                    class="active_workspace fs-5">{{ $workspce_data['active_workspace'] }}</span>
                            </p>
                        </div>
                        <div class="col-4 text-center">
                            ...
                            <p class=" text-sm mb-0">
                                <i class="ti ti-users text-danger card-icon-text-space fs-5 mx-1"></i><span
                                    class="disable_workspace fs-5">{{ $workspce_data['disable_workspace'] }}</span>
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-pane text-capitalize fade show {{ $loop->index == 0 ? 'active' : '' }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-11 col-md-10 col-sm-10 mt-3 text-end">
                                        <small
                                            class="text-danger my-3">{{ __('* Please ensure that if you disable the workspace, all users within this workspace are also disabled.') }}</small>
                                    </div>
                                        ...
                                        <div class="text-end">
                                            <div class="form-check form-switch custom-switch-v1 mt-3">
                                                <input type="checkbox" name="workspace_disable"
                                                    ...
                                                    data-id="{{ $user_data['workspace_id'] }}"
                                                    data-company="{{ $id }}"
                                                    data-name="{{ __('workspace') }}"
                                                    {{ $workspace->is_active == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="col-4 text-center">
                                        <p class="text-sm mb-0" data-toggle="tooltip"
                                            data-bs-original-title="{{ __('Total Users') }}"><i
                                                ...
                                                class="total_users fs-5">{{ $user_data['total_users'] }}</span>
                                    ...
                                    <div class="col-4 text-center">
                                        <p class="text-sm mb-0" data-toggle="tooltip"
                                            data-bs-original-title="{{ __('Active Users') }}"><i
                                                ...
                                                class="active_users fs-5">{{ $user_data['active_users'] }}</span>
                                        </p>
                                    </div>
                                    <div class="col-4 text-center">
                                        <p class="text-sm mb-0" data-toggle="tooltip"
                                            data-bs-original-title="{{ __('Disable Users') }}"><i
                                                ...
                                                class="disable_users fs-5">{{ $user_data['disable_users'] }}</span>
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-6 my-2 ">
                                            <div
                                                ...
                                                <div class="mb-3 mb-sm-0">
                                                    <h6>
                                                        <img @if ($userInfo->avatar) src="{{ asset(Storage::url('users-avatar/' . $userInfo->avatar)) }}" @else avatar="{{ $userInfo->name }}" @endif
                                                            id="myAvatar" alt="user-image" height="30"
                                                            class=" wid-30 rounded-circle mx-2" alt="image">
                                                        <label for="user"
                                                            class="form-label">{{ $userInfo->name }}</label>
                                                    </h6>
                                                </div>
                                                <div class="text-end ">
                                                    <div class="form-check form-switch custom-switch-v1 mb-2">
                                                        <input type="checkbox" name="user_disable"
                                                            ...
                                                            {{ $workspace->is_active == 1 ? '' : 'disabled' }}>
