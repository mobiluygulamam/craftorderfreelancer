                ...
                <div class="d-flex justify-content-end drp-languages">
                    <ul class="list-unstyled mb-0 m-3">
                        <a href="#" data-size="lg" data-ajax-popup-over="true" class="btn btn-sm btn-primary"
                            data-url="{{ route('generate', ['email template', $emailTemplate->id]) }}"
                            data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Generate with AI') }}"
                            data-title="{{ __('Generate Subject & Email Message') }}">
                        ...
                        <li class="dropdown dash-h-item drp-language">
                            ...
                            <div class="dropdown-menu dash-h-dropdown dropdown-menu-end" aria-labelledby="dropdownLanguage">
                                @foreach ($languages as $langCode => $lang)
                                    <a href="{{ route('manage.email.language', [$emailTemplate->id, $langCode]) }}"
                                        class="dropdown-item {{ $currEmailTempLang->lang == $langCode ? 'text-primary' : '' }}">{{ ucfirst(\App\Models\Utility::getlang_fullname($langCode)) }}</a>
                                @endforeach
                            </div>
                        </li>
                    </ul>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body ">
                    ...
                    {{ Form::model($currEmailTempLang, ['route' => ['email_template.update', $currEmailTempLang->parent_id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            {{ Form::label('content', __('Email Message'), ['class' => 'form-label text-dark']) }}<x-required></x-required>
                            {{ Form::textarea('content', $currEmailTempLang->content, ['class' => 'summernote', 'required' => 'required', 'id' => 'summernote']) }}
                        </div>
                    </div>
