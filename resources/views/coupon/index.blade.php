...
@section('action-button')
    <a href="#" class="btn btn-sm btn-primary" data-toggle="tooltip" title="{{ __('Add Coupon') }}" data-ajax-popup="true"
        data-size="lg" data-title="{{ __('Add Coupon') }}" data-url="{{ route('coupons.create') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#"
                                                ...
                                                data-url="{{ route('coupons.edit', $coupon->id) }}" data-toggle="tooltip"
                                                title="{{ __('Edit') }}" data-size="lg" data-ajax-popup="true"
                                            ...
                                            <a href="#"
                                                ...
                                                data-confirm-yes="delete-form-{{ $coupon->id }}" data-toggle="tooltip"
                                                title="{{ __('Delete') }}">
